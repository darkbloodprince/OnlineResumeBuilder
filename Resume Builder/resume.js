...
function generateCv() {
    ...
    //skills 
    let skiT = document.getElementsByClassName('skField'); //getting obj of skField
    let str3 = ''

    for(let e of skiT) {
        str3 = str3 + `<li> ${e.value} </li>`
    }
    document.getElementById('skiT').innerHTML = str3;

    //Languages 
    let lanT = document.getElementsByClassName('skField'); //getting obj of laField
    let str4 = ''

    for(let e of skiT) {
        str4 = str4 + `<li> ${e.value} </li>`
    }
    document.getElementById('lanT').innerHTML = str4;
